...
var serverData = {
    'jou': {
        name:"Journals of the Unknown",
        platforms:{
            "Facebook":{countersUrl:"mysterygame-counters-prod.azurewebsites.net",node:["mysterygamenode-journalsofunknown.azurewebsites.net","mysterygamenode02-journalsofunknown.azurewebsites.net","mysterygamenode03-journalsofunknown.azurewebsites.net"],dollarConversion:0.1, comision:0.3},
            "iPad":{countersUrl:"mysterygame-counters-ios.azurewebsites.net",node:["mysterygamenode-journalsofunknown.azurewebsites.net","mysterygamenode02-journalsofunknown.azurewebsites.net","mysterygamenode03-journalsofunknown.azurewebsites.net"],dollarConversion:0.1, comision:0.3},
            "Android":{countersUrl:"mysterygame-counters-android.azurewebsites.net",node:["mysterygamenode-journalsofunknown.azurewebsites.net","mysterygamenode02-journalsofunknown.azurewebsites.net","mysterygamenode03-journalsofunknown.azurewebsites.net"],dollarConversion:0.1, comision:0.3},
            ok:{countersUrl:"mysterygame-counters-ok.azurewebsites.net",node:["mysterygame-node-rusiaok.azurewebsites.net","mysterygame-node-rusiaok2.azurewebsites.net"],dollarConversion:(1/60), comision:0},
            vk:{countersUrl:"mysterygame-counters-vk.azurewebsites.net",node:["mysterygame-node-rusiavk.azurewebsites.net"],dollarConversion:(1/60), comision:0},
            mobage:{countersUrl:"mysterygame-counters-mobage.azurewebsites.net",node:["mysterygamenode-mobage-prod.azurewebsites.net"],dollarConversion:0.01, comision:0.807}
        }
    },
    'sherlock': {
        name:"Sherlock",
        platforms:{
            "Facebook":{countersUrl:"mysterygame-counters-sherlock.azurewebsites.net",node:["mysterygame-sherlock-prod.azurewebsites.net"],dollarConversion:0.1, comision:0.3},
            "iPad":{countersUrl:"mysterygame-counters-sherlock-ios.azurewebsites.net",node:[],dollarConversion:0.1, comision:0.3},
            "iPhone":{countersUrl:"mysterygame-counters-sherlock-iphone.azurewebsites.net",node:[],dollarConversion:0.1, comision:0.3}
        }
    }
}
    ...
    for(var platform in platforms){
        for(var i = 0;i<platforms[platform].node.length;i++){
            if(urls.indexOf(platforms[platform].node[i]) < 0){
                ...
                xhr.open("GET", protocol + "://"+platforms[platform].node[i]+"/metrics/internal/request/?id=revenue&fromDate=" + fromDate.toUTCString() + "&toDate=" + toDate.toUTCString(), true);
            }
        }
    }
...
function requestCounters(fromDate, toDate) {
    ...
    for(var platform in platformsInfo){
        ...
        xhrCounters[platform].open("GET", protocol + "://"+platformsInfo[platform].countersUrl+"/getCounters/General/Dialy/?fromDate=" + fromDate.toUTCString() + "&toDate=" + toDate.toUTCString(), true);
    }
...
function updateInfo(info, type) {
    ...
    document.getElementById('arppu_'+type).innerHTML = '<b>ARPPU:</b> $' + ((info.Payers) ? (formatMoney(info.Revenue / info.Payers)) : 0);
    document.getElementById('arpdau_'+type).innerHTML = '<b>ARPADAU:</b> $' + Math.round(((info.DAUS)?(info.Revenue / info.DAUS):0) * 1000) / 1000;
